...
**Thomas's direction:** Define enterprise IT lifecycle types from thought to testable product. Fully traceable. Gap visibility during planning. Testable milestones. Non-functional requirements.
...
**Thomas's direction:** Define who does what for each type. Determine how many agents we need.
